package com.haotian.provider2.serivce.impl.Config;
...
@EnableJpaRepositories(
        ...
        basePackages= { "com.haotian.api.SecondaryDatabase.Dao" }) //设置Repository所在位置
...
//    }
    ...
    public LocalContainerEntityManagerFactoryBean slaveEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        ...
        return builder
                ...
                .packages("com.haotian.api.Entity")//实体类的目录
